    ...
    return(
        <div>
            ...
            <div className={`${ProjectTwoCSS.card}`}> 
                ...
                <a href="https://github.com/Rahman223/ToolsOverflow" rel="noreferrer" target="_blank" className={`${ProjectTwoCSS.links} btn`} style={{paddingTop: "0", paddingBottom: "0", paddingLeft:"0"}}><i className="fab fa-github" style={{fontSize :"xx-large"}}></i> </a>
                <a href="https://tools-overflow.herokuapp.com/" rel="noreferrer" target="_blank" className={`${ProjectTwoCSS.links} btn`} style={{marginRight: "auto", paddingTop: "0", paddingBottom: "0"}}><i className="fas fa-external-link-alt" style={{fontSize :"xx-large"}}></i></a>
